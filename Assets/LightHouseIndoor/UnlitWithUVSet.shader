...
////// Emissive:
                ...
                outEmission = half4( ((_BaseTint.rgb*_MainTex_var.rgb)*saturate((_AOTex_var.rgb+_AOTint.rgb))), 1 );
                #ifndef UNITY_HDR_ON
